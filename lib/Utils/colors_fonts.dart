...
const greenColor = Color.fromARGB(255, 87, 196, 91);
...
const pendingFont = TextStyle(
  color: orangeColor,
  fontSize: 20,
);

const acceptedFont = TextStyle(
  color: greenColor,
  fontSize: 20,
);
const declinedFont = TextStyle(
  color: lightRedColor,
  fontSize: 20,
);
...
const deleteSmallFont = TextStyle(
  color: redColor,
  fontSize: 18,
);
